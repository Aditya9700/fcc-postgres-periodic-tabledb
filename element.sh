...
QUERY () {
  ...
  echo "The element with atomic number ${NUMBER// /} is$NAME (${SYMBOL// /}). It's a nonmetal, with a mass of ${MASS// /} amu.$NAME has a melting point of ${MELTING_PT// /} celsius and a boiling point of ${BOILING_PT// /} celsius."
}
